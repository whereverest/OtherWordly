    ...
    <svelte:fragment slot="content">
      <div
        class={`stats-container
                    ...
                    ${
                      !isPageLoaded &&
                      "level-results-page__stats-container--invisible"
                    }
                    ${
                      $isPortraitMode &&
                      "level-results-page__stats-container--bottom-margin"
                    }`}
      >
        <StatsFrame class="stats-container__stats-frame" isSmallerFont={true} />
      </div>
    </svelte:fragment><!-- / slot: content -->
