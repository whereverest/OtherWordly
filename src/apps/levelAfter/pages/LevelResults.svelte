    ...
    <svelte:fragment slot="header-left">
      <UserStatsSnippet
        class={ `level-results-page__user-stats-snippet
                  ${!isPageLoaded && 'level-results-page__user-stats-snippet--invisible'}` }
    ...
    <svelte:fragment slot="content">
      <div class="level-results-page__page-content">
        ...
        <div class={ `level-results
                      ...
                      ${$isPortraitMode && 'level-results-page__level-results--vertical'}` }>

          <div class={ `level-results__left-panel
                        ${$isPortraitMode && 'level-results__left-panel--wide'}
                        ${$isPortraitMode && 'level-results__left-panel--vertical'}
                        ${$isPortraitMode && 'level-results__left-panel--last'}` }>

            <!-- Stars & Goals -->
            <ul class={ `stars-n-goals
                          stars-n-goals--small
                          level-results__stars-n-goals
                          level-results__stars-n-goals--small
                          ${!isPageLoaded && 'level-results__stars-n-goals--invisible'}` }>
              <li class="stars-n-goals__goal-item">

                <Icon
                  class={ `stars-n-goals__star-icon
                            ${!is1800msPassed && 'stars-n-goals__star-icon--transition-from-props'}` }
                  data={ starOutlinedFilledIcon }
                />
                <div class={ `stars-n-goals__text-container
                              ${!is1200msPassed && 'stars-n-goals__text-container--transition-from-props'}` }>
              ...
              <li class="stars-n-goals__goal-item">
                ...
                <Icon
                  class={ `stars-n-goals__star-icon
                            ${!is2000msPassed && 'stars-n-goals__star-icon--transition-from-props'}
                            stars-n-goals__star-icon--translucent` }
                  data={ starHollowIcon }
                />
                <div class={ `stars-n-goals__text-container
                              ${!is1400msPassed && 'stars-n-goals__text-container--transition-from-props'}` }>
              ...
              <li class="stars-n-goals__goal-item">
                ...
                <Icon
                  class={ `stars-n-goals__star-icon
                            ${!is2200msPassed && 'stars-n-goals__star-icon--transition-from-props'}` }
                  data={ starOutlinedFilledIcon }
                />
                <div class={ `stars-n-goals__text-container
                              ${!is1600msPassed && 'stars-n-goals__text-container--transition-from-props'}` }>
            ...
            {#if $isPortraitMode}
              <div class={ `level-results__play-button-container
                            ${!is800msPassed && 'level-results__play-button-container--transition-from-props'}
          ...
          <div class={ `level-results__center-panel
                        ${$isPortraitMode && 'level-results__center-panel--with-bottom-margin'}
                        ${!isPageLoaded && 'level-results__center-panel--invisible'}` }>

            <!-- Rope title -->
            <div class={ `rope-title
                          level-results__rope-title
                          ${$isPortraitMode && 'level-results__rope-title--small'}
                          ${!is400msPassed && 'level-results__rope-title--transition-from-props'}` }>
              ...
              <div class="rope-title__big-rope">
                ...
                <svg class="rope-title__big-rope-bg" width="512" height="158" viewBox="0 0 512 158">
                  <path style="fill-rule: evenodd; fill: {'#' + 'eeb59e'}" d="M471.105,119.179L484.05,158a429.067,429.067,0,0,0-80.964-30.794l19.932-55.218c31.911,8.541,61.176,19.473,86.974,32.351ZM40.984,119.17L1.989,104.385C27.859,91.552,57.2,80.658,89.2,72.147l19.988,55.027A431.817,431.817,0,0,0,28,157.859Z"/>
                  <path style="fill-rule: evenodd; fill: {'#' + 'ce8c79'}" d="M460.33,127.01H403.717l29.541-82.025h59.178ZM19.564,45.134H78.7l29.513,81.746H51.644Z"/>
                  <path style="fill-rule: evenodd; fill: #fff" d="M256,0A640.276,640.276,0,0,1,492.451,45.29l-32.075,81.684C395.52,101.167,326.944,87.316,256,87.316S116.48,101.167,51.624,126.974L19.549,45.29A640.28,640.28,0,0,1,256,0Z"/>
                </svg>
              ...
              <div class="rope-title__small-rope">
                ...
                <svg class="rope-title__small-rope-bg" xmlns="http://www.w3.org/2000/svg" width="512" height="161" viewBox="0 0 512 161">
                  <path style="fill-rule: evenodd; fill: {'#' + 'eeb59e'}" d="M389.085,151.422c-28.769-4.152-62.571-6.549-98.754-6.549-57.644,0-109.274,6.073-144.071,15.658l-4.45-48.345c34.761-10.316,88.368-16.93,148.521-16.93,37.246,0,71.98,2.537,101.289,6.917Z"/>
                  <path style="fill-rule: evenodd; fill: {'#' + 'ce8c79'}" d="M391.773,99.2l-2.7,52.449c-45.655-20.121-132.685-33.717-232.559-33.717-49.165,0-95.219,3.3-134.757,9.041l9.27-24.2Z"/>
                  <path style="fill-rule: evenodd; fill: {'#' + 'eeb59e'}" d="M511.928,24.571L490.076,127.755c-145.231-26.946-322.918-26.948-468.153,0L0.071,24.567C156.23-8.123,355.773-8.121,511.928,24.571Z"/>
                </svg>
              </div>
            ...
            {#if $isPortraitMode}
              <SpeechChatbox
                class={ `level-results__chatbox
                          ${!is800msPassed && 'level-results__chatbox--transition-from-props'}
            ...
            <div class={ `level-results__char-avatar-container
                          ${$isPortraitMode && 'level-results__char-avatar-container--negative-bottom-margin'}
                          ${!isPageLoaded && 'level-results__char-avatar-container--invisible'}` }>
              <img class="level-results__char-avatar" src={ char03_jaleen } alt="avatar" />
            </div>


            <!-- Curved table stats -->
            <div class={ `curved-table-stats
                          level-results__curved-table-stats
                          ${!isPageLoaded && 'level-results__curved-table-stats--invisible'}` }>

              <div class={ `improved-results-badge
                            curved-table-stats__improved-results-badge
                            ${!is3200msPassed
                                      && 'curved-table-stats__improved-results-badge--transition-from-props'}
                            ${$isPortraitMode && 'curved-table-stats__improved-results-badge--small'}` }>

                <div class="improved-results-badge__text-line">Improved</div>
                <div class="improved-results-badge__text-line
                            improved-results-badge__text-line--big">Result!</div>
              ...
              <div class="curved-table-stats__dividers-container"></div>

              <div class="matches-n-throws
            ...
            </div><!-- / Curved table stats -->

          </div>

          {#if !$isPortraitMode}
          <div class={ `level-results__right-panel
                        ${!isPageLoaded && 'level-results__right-panel--invisible'}` }>

            <SpeechChatbox
              class={ `${!is800msPassed && 'level-results__chatbox--transition-from-props'}
            ...
            <div class={ `level-results__play-button-container
                        ${!is1000msPassed && 'level-results__play-button-container--transition-from-props'}` }>
              <ButtonInCircle
                class="level-results__play-button"
                backwardsGradient={true}
                prominent={true}
  ...
  &__goal-item {
    ...
    :global(.stars-n-goals__star-icon) {
      ...
      :global(.stars-n-goals__star-icon--transition-from-props) {
        transform: rotate(300deg) scale(4.0) translateZ(0);
        opacity: 0;
      }
...
.rope-title {
  ...
  &__big-rope {
    ...
    :global(.rope-title__big-arc-text) {
      ...
      max-height: 2.4rem;
      position: absolute;
      inset: 1px auto auto calc(50% - 4.0rem);
      font-family: 'MuseoSlabRounded-700',serif;
      text-transform: none;
    }
  ...
  &__small-rope {
    ...
    :global(.rope-title__small-arc-text) {
      ...
      max-height: 2.4rem;
      position: absolute;
      inset: -.13rem auto auto calc(50% - 4.0rem);
...
.matches-n-throws {
  ...
  :global(.matches-n-throws__overlay) {
    ...
    height: 5.0rem;
    position: absolute;
    inset: calc(50% - 2.5rem) auto auto calc(50% - 10.0rem);
    transform: scale(1.4);
...
.curved-table-stats {
  ...
  &__dividers-container {
    ...
    &::before {
      ...
      border-radius: 50%;
      position: absolute;
      inset: auto auto 4.2rem calc(50% - 20.0rem);
      mask-image: linear-gradient(180deg, rgba(0,0,0,0) 95%, rgba(0,0,0,1) 100%);
    }
  ...
  &__improved-results-badge {
    position: absolute;
    inset: 3.0rem auto auto -7.0rem;
    transform: rotate(-23deg) scale(1) translateZ(0);
    transition: transform .25s linear, opacity .6s ease;
    opacity: 1;

    &--small {
      inset: 2.0rem auto auto -6.0rem;
      transform: rotate(-23deg) scale(.8) translateZ(0);
    }

    &--transition-from-props {
      transform: rotate(150deg) scale(3.0) translateZ(0);
      opacity: 0;
    }
  }
