    ...
    "
      ...
      <svelte:fragment slot="content">
          ...
          <div class={ `chapter-details-page__flying-card-container
                  ...
                  ${$isPortraitMode && 'chapter-details-page__flying-card-container__with-portrait-mode'}
                  ${isFlyingCardMoveToTheLeft && $transitionTo  !== 'AllChapters'
                                        && !$isPortraitMode && 'chapter-details-page__flying-card-container--placed-on-left'}
                  ${isFlyingCardMoveToTheLeft && $transitionTo  !== 'AllChapters'
                                        && $isPortraitMode && 'chapter-details-page__flying-card-container__with-portrait-mode--placed-on-left'}
          ...
          <div class={ `chapter-details-page__content-divider-line
                  ${$isPortraitMode && 'chapter-details-page__content-divider-line__with-portrait-mode'}
          ...
          <div class={ `chapter-details-page__chapter-description
                  ${$isPortraitMode && 'chapter-details-page__chapter-description__with-portrait-mode'}
                  ${(!isAllPageElementsVisible || $transitionFrom === 'Chapter')
          ...
          <div class={ `level-rewards
                  ...
                  ${$isPortraitMode && 'chapter-details-page__level-rewards__with-portrait-mode'}`}>
              ...
              >
                  <div class={`level-rewards__five-obs-region
                  ${$isPortraitMode && 'level-rewards__five-obs-region__with-portrait-mode'}
                  `}></div>
              </div>
          ...
          <div class={ `chapter-details-page__content-play-container
                  ${(!isAllPageElementsVisible || $transitionFrom === 'Chapter')
                                      && 'chapter-details-page__content-play-container--invisible'}
                  ${$isPortraitMode && 'chapter-details-page__content-play-container__with-portrait-mode'}
                                      `}>

              <div class={`chapter-details-page__content-play-container--upper
                  ${$isPortraitMode && 'chapter-details-page__content-play-container--upper__with-portrait-mode'}
                                      `}></div>
              <RoundButton isThickBorder=true textInCircle="Play"></RoundButton>
              <div class={`chapter-details-page__content-play-container--lower
                  ${$isPortraitMode && 'chapter-details-page__content-play-container--lower__with-portrait-mode'}
                                      `}></div>
          </div>
      </svelte:fragment><!-- / slot: content -->
...
<script>
  ...
  // Computed -------------------------------------------------------------------
  $: currentChapter = $chaptersList.find(item => {
...
@media (min-width: 927px) {
  ...
  .level-select-n-play-but {
    font-size: calc((var(--app-height) + var(--app-height) * .8) / 100);
  ...
  &__content-play-container{
    ...
    &--upper{
      ...
      &::before {
        ...
        touch-action: none;
        border: .1rem rgba(255,255,255,.9) solid;
        border-radius: 40.0rem;
        mask-image: linear-gradient(0deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 20%);
      }
       &__with-portrait-mode{
         height: .2rem;
    ...
    &--lower{
      background: linear-gradient(0deg, rgba(255, 255, 255, 1) 100%, rgba(255, 255, 255, 0) 0%);
      opacity: 0.25;
      width:  .2rem;
      height: calc(var(--app-height)/2 - 12rem);
      position: relative;
