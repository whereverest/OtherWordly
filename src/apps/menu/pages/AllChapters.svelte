    ...
    {#if $starsEarned >= 4}
        ...
        >
            ...
            <div class="stars-counter__right-side">
                <div class="stars-counter__title">
                    Total Stars
                </div>
...
<!-- Flying card -->
<div class={ `all-chapters-page__flying-card-container
      ${isCardFacesVisible && 'all-chapters-page__flying-card-container--visible'}` }>
    <ChapterCard
...
<div class="all-chapters-page__page-footer-right">
    <div class={ `all-chapters-page__settings-button-wrapper
...
const isCardLocked = $chaptersList.find(item => item.chapterNum === cardId)?.isLocked;
const isCardUnlockable = $chaptersList.find(item => item.chapterNum === cardId)?.isUnlockable;
...
const currentCardIndex = $chaptersList.findIndex(item => item.chapterNum === cardId);
