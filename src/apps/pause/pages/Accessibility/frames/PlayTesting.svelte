<div class={ `playtesting-container
              ${mixClass}` }>
  ...
  <ScrollableBlock class="playtesting-container__scrollable-block">
    <div class="playtesting-container__in-wrap">
      ...
      <p>
        Change goal progress by tapping the left/right sides of the energy/candy gauge.
      </p>
      <br>

      <div class="playtesting-container__divider-horizontal"></div>

      <div class="playtesting-container__group-of-elements">
        <ButtonPill
          class="playtesting-container__button-pill"
          text="Show Intro"
          on:click={ () => dispatchIOSEventWrapper({'tapped':'OWJSMsgShowIntro'}) }
        />
        <ButtonPill
          class="playtesting-container__button-pill"
          text="Unlock all Levels"
          on:click={ () => dispatchIOSEventWrapper({'tapped':'OWJSMsgUnlockAllLevels'}) }
        />
        <ButtonPill
          class="playtesting-container__button-pill"
          text="Set Random Level Progress"
          on:click={ () => dispatchIOSEventWrapper({'tapped':'OWJSMsgSetRandomLevelProgress'}) }
        />
      </div>
      ...
      <p>
        You can switch the content of all levels (except tutorial level #1) into Polish. There are only 5 Polish samples, so you'll see words repeating.
      </p>
      ...
      <div class="playtesting-container__group-of-elements">
        <ButtonPill
          ...
          on:click={ () => dispatchIOSEventWrapper({'tapped':'OWJSMsgPolishWords'}) }
        />
        <ButtonPill
          class="playtesting-container__button-pill"
          text="Normal English"
          on:click={ () => dispatchIOSEventWrapper({'tapped':'OWJSMsgNormalEnglish'}) }
        />
      </div>
