<script>
  ...
  $: gameplayDetailsSections = convertItemsListIntoPairsList(
    data.gameplayDetails
  );
...
>
  <BasicPageLayout class="how-to-page__basic-layout-container">
    ...
    <svelte:fragment slot="content">
      <ScrollableBlock
        class={`how-to-page__scrollable-block ${
          $isPortraitMode && "how-to-page__scrollable-block__portrait-mode"
        }`}
      >
        <!-- How to manual -->
        <div
        ...
        >
          ...
          <div class="how-to-manual__divider-horizontal" />
...
<style lang="scss">
  ...
  .how-to-page {
    ...
    :global(.how-to-page__scrollable-block) {
      ...
      align-items: center;
      position: absolute;
      inset: calc(50% - (50vh - 5rem)) auto auto calc(50% - (50vw - 9rem));
    }
