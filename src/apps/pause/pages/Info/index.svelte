          ...
          {#if activeSlide !== 4}
            <div
              ...
              class={`arrow-btn
                      ...
                      `}
              on:click={() =>
                (activeSlide = activeSlide === 4 ? 4 : activeSlide + 1)}
            >
          ...
          <div class="frames-list__in-wrap1">
            ...
            >
              <div class="frames-list__frame-wrap">
                <StatsFrame class="frames-list__frame" />
              </div>
              <div class="frames-list__frame-wrap">
                <ShareFrame class="frames-list__frame" />
              </div>
              <div class="frames-list__frame-wrap">
                <MusicFrame class="frames-list__frame" />
              </div>
              <div class="frames-list__frame-wrap">
                <HaikuFrame class="frames-list__frame" />
              </div>
              <div class="frames-list__frame-wrap">
                <CreditsFrame class="frames-list__frame" />
              </div>
            </div>
          </div>
        </div>
