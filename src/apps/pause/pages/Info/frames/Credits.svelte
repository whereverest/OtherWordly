...
>
  <ScrollableBlock class="credits-container__scrollable-block">
    <div class="credits-container__in-wrap">
      ...
      >
        <div
          class="columns-container__separate-column
                    columns-container__separate-column--50-percent-width"
        >
          <div
            class="credits-container__tertiary-title
                      credits-container__tertiary-title--small-bottom-margin"
          >
            Producer
          </div>
          <div
            class="credits-container__secondary-title
                      credits-container__secondary-title--big-bottom-margin"
          >
            Michael Douma
          </div>
      ...
      <div class="credits-container__divider-horizontal" />
      ...
      <div
        class="credits-container__tertiary-title
                  credits-container__tertiary-title--big-bottom-margin"
      >
        Contributors
      </div>
      ...
      >
        ...
        >
          ...
          <div
            class="credits-container__quaternary-title
                      credits-container__quaternary-title--small-bottom-margin"
          >
            Jessica L. Montag,
          </div>
          <div
      ...
      >
        ...
        >
          ...
          >
            HighTechU at University of Victoria
          </div>
        ...
        >
          ...
          <div
            ...
            style="text-transform: none"
          >
            Experiential Network (XN) at Northeastern University
          </div>
          <div
            class="credits-container__quaternary-title
                      credits-container__quaternary-title--small-bottom-margin"
        ...
        >
          <div
            class="credits-container__quaternary-title
                      credits-container__quaternary-title--small-bottom-margin"
          >
            XSEDE Supercomputer grant IRI140002
          </div>
        </div>
      </div>
      <!-- / Columns container -->
