...
>
  <ScrollableBlock class="stats-container__scrollable-block">
    <div
      class={`stats-container__in-wrap
                  ${$isPortraitMode && "stats-container__in-wrap--vertical"}`}
    >
      <div
        class={`stats-container__column
      ...
      >
        <TwoColorsTitle
          class={`stats-container__title
                  ${
                    $isPortraitMode &&
                    "stats-container__title--smaller-bot-margin"
                  }`}
          text="Level Stats"
          isNoWrap={true}
        ...
        <ul class="stats-container__stats-list">
          {#each stats.levelStats as stat, index (index)}
            ...
            >
              <div
                class={`stats-snippet__value
                          ${
                            isSmallerFont &&
                            "stats-snippet__value--smaller-font"
                          }
              ...
              <div
                class={`stats-snippet__description
                          ${
                            isSmallerFont &&
                            "stats-snippet__description--smaller-font"
                          }
                          ${
                            $isPortraitMode &&
                            "stats-snippet__description--narrow"
                          }`}
              >
                {stat.name}
              </div>
      ...
      {#if $isPortraitMode}
        <div class="stats-container__horizontal-divider" />
      {:else}
        <div class="stats-container__vertical-divider" />
      {/if}
