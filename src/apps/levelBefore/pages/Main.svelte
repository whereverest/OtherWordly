<script>
  ...
  $: currentStoryArray = isTutorial
    ? defaultLevelDataTutorial.story
    : levelData[currentLevelDataIndex].story || defaultLevelDataNormal.story;
...
>
  <div class="test-button2" on:click={toggleIsTutorial} />
            ...
            >
              <div
                ...
                class={`tap-to-continue-button
                        ...
                        ${
                          $isPortraitMode &&
                          "tap-to-continue-button--portrait-mode"
                        }
                        `}
...
<style lang="scss">
  ...
  .main-page {
    &--with-bg-image {
      background: 50% 50% / cover url(../../../assets/images/menu_bg3.jpg)
        no-repeat;
    }
